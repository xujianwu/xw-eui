...
// ../../_node_modules/vitepress-view-component/_product/preview-component.js
var T = (o, e) => {
...
function Q(o, e) {
  return openBlock(), createElementBlock("svg", K, e[0] || (e[0] = [
...
function Y(o, e) {
  return openBlock(), createElementBlock("svg", X, e[0] || (e[0] = [
    createBaseVNode("path", {
...
function ne(o, e) {
  return openBlock(), createElementBlock("svg", te, e[0] || (e[0] = [
    createBaseVNode("path", {
...
function ce(o, e) {
  return openBlock(), createElementBlock("svg", se, e[0] || (e[0] = [
    createBaseVNode("path", {
...
var le = defineComponent({
  ...
  setup(o, { expose: e }) {
    ...
    return e({
      setVisible: m,
      setTopHeight: f
    }), (u, h) => (openBlock(), createBlock(Transition, {
      name: "slide-fade",
      onAfterLeave: C
    }, {
      default: withCtx(() => [
        l.value ? (openBlock(), createElementBlock("div", {
          ...
          style: normalizeStyle({ top: L.value + "px" })
        }, [
          createVNode(ie),
...
var D = {
  open: () => {
    const o = document.createElement("div"), e = createApp(le, {
      content: "复制成功！",
      close: () => {
        document.body.removeChild(o), I.pop(), e.unmount();
      }
    }), t = e.mount(o);
    document.body.appendChild(o);
    const c = I.length, l = c === 0 ? 10 : (c + 1) * 10 + c * 42;
    t.setTopHeight(l), t.setVisible(true), I.push(t);
  }
};
var re = ["innerHTML"];
var ae = ["innerHTML"];
var pe = defineComponent({
  ...
  setup(o) {
    const e = o, t = A(), { isCodeFold: c, setCodeFold: l } = R(), { copyContent: m, clickCopy: L } = E(), f = ref(decodeURIComponent(e.code)), C = ref(decodeURIComponent(e.showCode)), u = ref(null), h = () => {
      L(f.value), D.open();
    }, _ = computed(() => {
      var r;
    ...
    return onMounted(() => {
      ...
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("section", {
          ...
          }, null, 10, re)) : createCommentVNode("", true),
...
var ve = defineComponent({
  ...
  setup(o) {
    const e = o, t = A(), { isCodeFold: c, setCodeFold: l } = R(), { clickCopy: m } = E(), L = ref(decodeURIComponent(e.code)), f = ref(decodeURIComponent(e.showCode)), C = ref(null), u = () => {
      m(L.value), D.open();
    }, h = computed(() => {
      var s;
...
export {
  pe as AntDesignContainer,
  ve as ElementPlusContainer,
  me as NaiveUIContainer
};
//# sourceMappingURL=@vitepress-preview_component.js.map
